...
The browser UI is an evaluator-facing dashboard: it displays indexed-document and chunk counts, retrieval depth, answer model, support status, citation-validation outcome, citation count, top and average similarity scores, and the three ranked evidence chunks used for each response.
